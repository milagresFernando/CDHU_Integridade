...
function ParallaxIlustraControlador(props) {
  let n1ValueDesk = 10;
  let n1ValueTablet = 4;
  let n1ValueMobile = 4;
  ...
  return (
    <Fragment>
      <div className="baseSize ilustraControlador">
        <SvgParallax
          svgName="ControladorN1"
          svgParallaxClassName="zindex3"
          className="ilustrasBase controladorBase"
          parallaxRef={n1.ref}
          monitoraMudanca={monitoraMudanca}
        />
        <SvgParallax
          svgName="ControladorN2"
...
export default ParallaxIlustraControlador;
