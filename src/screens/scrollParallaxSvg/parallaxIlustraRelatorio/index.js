...
function ParallaxIlustraRelatorio(props) {
  let n1ValueDesk = 6;
  let n1ValueTablet = 4;
  let n1ValueMobile = 4;
  ...
  return (
    <Fragment>
      <div className="baseSize ilustraRelatorio">
        <SvgParallax
          svgName="IlustraRelatorioN1"
...
export default ParallaxIlustraRelatorio;
