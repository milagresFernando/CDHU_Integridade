...
function ParallaxIlustraConsentimento(props) {
  let n1ValueDesk = 6;
  let n1ValueTablet = 4;
  let n1ValueMobile = 4;
  ...
  return (
    <Fragment>
      <div className="baseSize ilustraConsentimento">
        <SvgParallax
          svgName="IlustraConsentimentoN1"
        ...
        />
        <SvgParallax
          svgName="IlustraConsentimentoN2"
        ...
        />
        <SvgParallax
          svgName="IlustraConsentimentoN3"
...
export default ParallaxIlustraConsentimento;
