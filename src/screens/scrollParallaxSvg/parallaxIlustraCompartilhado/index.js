...
function ParallaxIlustraCompartilhado(props) {
  let n1ValueDesk = 6;
  let n1ValueTablet = 4;
  let n1ValueMobile = 4;
  ...
  return (
    <Fragment>
      <div className="baseSize ilustraCompartilhado">
        <SvgParallax
          svgName="IlustraCompartilhadoN1"
        ...
        />
        <SvgParallax
          svgName="IlustraCompartilhadoN2"
        ...
        />
        <SvgParallax
          svgName="IlustraCompartilhadoN3"
...
export default ParallaxIlustraCompartilhado;
