...
function ParallaxIlustraAplicacao(props) {
  let n1ValueDesk = 10;
  let n1ValueTablet = 4;
  let n1ValueMobile = 4;
  ...
  return (
    <Fragment>
      <div className="baseSize ilustraAplicacao">
        <SvgParallax
          svgName="AplicacaoN1"
          svgParallaxClassName="zindex3"
          className="ilustrasBase aplicacaoBase"
          parallaxRef={n1.ref}
...
export default ParallaxIlustraAplicacao;
