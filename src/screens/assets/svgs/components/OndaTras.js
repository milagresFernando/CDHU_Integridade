...
function OndaTras(props) {
  return (
    <svg data-name="ondaTras" viewBox="0 0 2246.03 800">
      <defs>
        <linearGradient
          id="OndaTrasId1"
          x1={1123.02}
      ...
      <path
        ...
        fill="url(#OndaTrasId1)"
      />
    </svg>
  );
}

const MemoOndaTras = React.memo(OndaTras);
export default MemoOndaTras;
